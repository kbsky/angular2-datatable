...
var slice_1 = require("lodash/slice");
...
var DataTable = (function () {
    ...
    DataTable.prototype.setSort = function (sortBy, sortOrder) {
        if (this.sortBy !== sortBy || this.sortOrder !== sortOrder) {
            this.sortBy = sortBy;
            this.sortOrder = includes_1.default(["asc", "desc"], sortOrder) ? sortOrder : "asc";
    ...
    DataTable.prototype.ngOnChanges = function (changes) {
        ...
        if (changes["sortBy"] || changes["sortOrder"]) {
            if (!includes_1.default(["asc", "desc"], this.sortOrder)) {
    ...
    DataTable.prototype.fillData = function () {
        ...
        if (typeof sortBy === 'string' || sortBy instanceof String) {
            data = orderBy_1.default(data, this.caseInsensitiveIteratee(sortBy), [this.sortOrder]);
        }
        else {
            data = orderBy_1.default(data, sortBy, [this.sortOrder]);
        }
        data = slice_1.default(data, offset, offset + this.rowsOnPage);
        this.data = data;
    };
